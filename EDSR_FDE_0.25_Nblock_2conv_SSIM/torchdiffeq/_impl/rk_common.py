...
"""
k1=f(xn,y(xn))           #xn-->y(n)
k(i)=f(xn+h*lamta(i),y(xn)+h*[sigama求和（miu(ij)*k(j)）])
四阶rk方法：最终泰勒展开系数对比构成的公式里有11个方程，13个未知数，固有两个字有参数
lamta(2)=0.5，lamta(2)=1-lamta(3)
miu(43)=1时，rk4_step_func：
y(n+1)=y(n)+1/6h(k1+2k2+2k3+k4)
k1=f(xn,y(n))
k2=f(xn+0.5h,y(n)+0.5hk1)
k3=f(xn+0.5h,y(n)+0.5hk2)
k4=f(xn+h,y(n)+hk3)
lamta(2)=1/3，lamta(2)=1-lamta(3)时，rk4_alt_step_func：
y(n+1)=y(n)+1/8h(k1+3k2+3k3+k4)
k1=f(xn,y(n))
k2=f(xn+1/3h,y(n)+1/3hk1)
k3=f(xn+2/3h,y(n)-1/3hk1+hk2)
k4=f(xn+h,y(n)+h(k1-k2+k3))
"""
